      ...
      <header className="adm-head sticky top-0 z-40 w-full flex items-center justify-between px-3 sm:px-6">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          ...
          {isLoggedIn ? (
            <Link
              href="/dashboard"
              className="hidden sm:inline-flex items-center gap-1.5 rounded-md bg-primary px-3 py-1.5 text-xs font-semibold text-primary-foreground shadow-xs transition hover:bg-primary/90"
            >
          ...
          <div className="fixed inset-y-0 left-0 w-[280px] bg-background border-r p-5 shadow-xl flex flex-col z-50">
            ...
            <div className="pt-4 border-t space-y-2">
              {isLoggedIn ? (
                <Link
                  href="/dashboard"
                  className="flex w-full items-center justify-center gap-2 rounded-md bg-primary py-2 text-xs font-semibold text-primary-foreground shadow-xs"
                >
